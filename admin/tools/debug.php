        ...
        <div style="width:100%;">
            <div id="requestDev">
                ...
                <form method="POST" action="?" enctype="multipart/form-data" id="redisQuery">
                    ...
                    conn: <input type="text" name="conn" value="" size="25"/><br/>
                    key: <input type="text" name="prefix" value="" size="25"/><br/>
                    ...
                    <button type="button" value="delKey" onclick="devObject.delKey();" >delKey</button>&nbsp;&nbsp;&nbsp;&nbsp;
                    <button type="button" value="AjaxRun" onclick="javascript: devObject.fillResult('Receiving data ...');devObject.ajaxRedis();" >Query</button><br/>
                </form>
            </div>
            <div id="resultDiv">
